...
.closeup-duel { position: absolute; bottom: 4%; left: 6%; z-index: 4; background: rgba(18,20,42,.7); color: #D4A574; border: 1px solid rgba(212,165,116,.5); border-radius: 8px; padding: 8px 16px; cursor: pointer; }
.closeup-duel:hover { background: rgba(18,20,42,.9); box-shadow: 0 0 10px rgba(212,165,116,.5); }
```
