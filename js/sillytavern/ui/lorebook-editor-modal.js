...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=42';
import { saveLorebook } from '../database.js?v=42';
import { el, makeOverlay } from './dom.js?v=42';
import { renderEntryForm } from './entry-form.js?v=42';
