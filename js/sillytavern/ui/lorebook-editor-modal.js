...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=48';
import { saveLorebook } from '../database.js?v=48';
import { el, makeOverlay } from './dom.js?v=48';
import { renderEntryForm } from './entry-form.js?v=48';
