...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=49';
import { saveLorebook } from '../database.js?v=49';
import { el, makeOverlay } from './dom.js?v=49';
import { renderEntryForm } from './entry-form.js?v=49';
