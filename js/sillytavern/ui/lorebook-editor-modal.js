...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=23';
import { saveLorebook } from '../database.js?v=23';
import { el, makeOverlay } from './dom.js?v=23';
import { renderEntryForm } from './entry-form.js?v=23';
