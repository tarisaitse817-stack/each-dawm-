...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=36';
import { saveLorebook } from '../database.js?v=36';
import { el, makeOverlay } from './dom.js?v=36';
import { renderEntryForm } from './entry-form.js?v=36';
