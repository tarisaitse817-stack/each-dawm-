...
import { createDefaultEntry, updateEntry, removeEntry } from '../editor-utils.js?v=31';
import { saveLorebook } from '../database.js?v=31';
import { el, makeOverlay } from './dom.js?v=31';
import { renderEntryForm } from './entry-form.js?v=31';
